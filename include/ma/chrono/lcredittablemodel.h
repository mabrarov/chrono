...
#ifndef MA_CHRONO_LCREDITTABLEMODEL_H
#define MA_CHRONO_LCREDITTABLEMODEL_H
...
class LcreditTableModel : public BasicTableModel
{
  Q_OBJECT
...
public:
  ...
  LcreditTableModel(const DatabaseModelPtr& databaseModel,
...
private:
  Q_DISABLE_COPY(LcreditTableModel)
      
  OptionalInt filterId_;
}; // class LcreditTableModel

} // namespace chrono
} // namespace ma

#endif // MA_CHRONO_LCREDITTABLEMODEL_H
