...
#ifndef MA_CHRONO_CONTRACTBOLTABLEMODEL_H
#define MA_CHRONO_CONTRACTBOLTABLEMODEL_H
...
class ContractBolTableModel : public BasicTableModel
{
  Q_OBJECT

public:
  ContractBolTableModel(const DatabaseModelPtr& databaseModel,
      QObject* parent, const OptionalQInt64& contractId, 
      const FilterExpression& filterExpression, 
      const OrderExpression& orderExpression);
  ~ContractBolTableModel();            
...
private:
  Q_DISABLE_COPY(ContractBolTableModel)      

  OptionalQInt64 contractId_;
}; // class ContractBolTableModel

} // namespace chrono
} // namespace ma

#endif // MA_CHRONO_CONTRACTBOLTABLEMODEL_H
