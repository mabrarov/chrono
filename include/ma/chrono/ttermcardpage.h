...
#ifndef MA_CHRONO_TTERMCARDPAGE_H
#define MA_CHRONO_TTERMCARDPAGE_H

#if defined(_MSC_VER) && (_MSC_VER >= 1020)
#pragma once
#endif // defined(_MSC_VER) && (_MSC_VER >= 1200)

#include <ui_ttermcardpage.h>
...
class TtermCardPage : public CardPage
{
  Q_OBJECT

public: 
  TtermCardPage(const ResourceManagerPtr& resourceManager,
...
#endif // MA_CHRONO_TTERMCARDPAGE_H
