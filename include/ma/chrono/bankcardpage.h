...
#ifndef MA_CHRONO_BANKCARDPAGE_H
#define MA_CHRONO_BANKCARDPAGE_H

#if defined(_MSC_VER) && (_MSC_VER >= 1020)
#pragma once
#endif // defined(_MSC_VER) && (_MSC_VER >= 1200)

#include <ui_bankcardpage.h>
...
class BankCardPage : public CardPage
{
  Q_OBJECT

public: 
  explicit BankCardPage(const ResourceManagerPtr& resourceManager, 
...
private:
  Q_DISABLE_COPY(BankCardPage)

  void connectDataAwareWidgets(const QWidgetList& widgets);
  void updateWidgets();
...
#endif // MA_CHRONO_BANKCARDPAGE_H
