...
#ifndef MA_CHRONO_CONTRACTPAYSHEETTABLEMODEL_H
#define MA_CHRONO_CONTRACTPAYSHEETTABLEMODEL_H
...
class ContractPaysheetTableModel : public BasicTableModel
{
  Q_OBJECT

public:
  ContractPaysheetTableModel(
...
private:
  Q_DISABLE_COPY(ContractPaysheetTableModel)      

  OptionalQInt64 contractId_;
}; // class ContractPaysheetTableModel

} // namespace chrono
} // namespace ma

#endif // MA_CHRONO_CONTRACTPAYSHEETTABLEMODEL_H
