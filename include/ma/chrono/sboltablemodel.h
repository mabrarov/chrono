...
#ifndef MA_CHRONO_SBOLTABLEMODEL_H
#define MA_CHRONO_SBOLTABLEMODEL_H
...
class SbolTableModel : public BasicTableModel
{
  Q_OBJECT
...
public:
  ...
  SbolTableModel(const DatabaseModelPtr& databaseModel, 
...
private:
  Q_DISABLE_COPY(SbolTableModel)
      
  OptionalInt filterId_;
}; // class SbolTableModel

} // namespace chrono
} // namespace ma

#endif // MA_CHRONO_SBOLTABLEMODEL_H
