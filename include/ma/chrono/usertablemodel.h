...
#ifndef MA_CHRONO_USERTABLEMODEL_H
#define MA_CHRONO_USERTABLEMODEL_H
...
class UserTableModel : public BasicTableModel
{
  Q_OBJECT

public:
  UserTableModel(const DatabaseModelPtr& databaseModel,
...
private:
  Q_DISABLE_COPY(UserTableModel)
}; // class UserTableModel

} // namespace chrono
} // namespace ma

#endif // MA_CHRONO_USERTABLEMODEL_H
